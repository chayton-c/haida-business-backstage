...
public class AppTaskController extends BaseController {
    ...
    public Json measurementTasks() throws Exception {
        ...
        userIds.addAll(StreamUtil.getList(measurementTasks, MeasurementTask::getSubmitUserName)); // 提交人
        ...
        for (MeasurementTask measurementTask : measurementTasks) {
            ...
            measurementTask.setExecutorNames(executorName);

            measurementTask.setSubmitUserName(userNameMap.get(measurementTask.getSubmitUserName()));
