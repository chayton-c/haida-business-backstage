...
public class UploadConstructionControlPlanController extends BaseController {
    ...
    public Json importConstructionControlPlanPoint() throws Exception {
        ...
        List<AppConstructionControlPlanPoint> appConstructionControlPlanPoints = JsonUtils.parseList(constructionControlPlanPointsStr, AppConstructionControlPlanPoint.class);
        List<ConstructionControlPlanPoint> constructionControlPlanPoints = StreamUtil.getList(appConstructionControlPlanPoints, ConstructionControlPlanPoint::new);
        List<String> constructionControlPlanIds = StreamUtil.getList(constructionControlPlanPoints, ConstructionControlPlanPoint::getConstructionControlPlanId);
        ...
        for (ConstructionControlPlanPoint constructionControlPlanPoint : constructionControlPlanPoints) {
            ...
            String startStationId = constructionControlPlan.getStartStationId();
            List<Opc> opcs = opcService.getLineDataByStationId(startStationId);
