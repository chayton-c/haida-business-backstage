...
public interface MeasurementTaskDetailService {
    ...
    void deleteByMeasurementTaskId(String measurementTaskId);

    /**
     * 测量计划的设备附表生成任务附表
     */
    void createByDeviceMaintenancePlanDevices(String measurementTaskId, List<DeviceMaintenancePlanDevice> deviceMaintenancePlanDevices);
    ...
    void setMissed(MeasurementTask measurementTask);
}
