...
public interface MeasurementTaskService {
     ...
     */
    void saveOrUpdate(MeasurementTask pageMeasurementTask, List<DeviceMaintenancePlanDevice> devices, List<String> executeUserIds);
    ...
    List<MeasurementTask> getByDeviceMaintenancePlan(String deviceMaintenancePlanId);
