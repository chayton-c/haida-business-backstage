...
public class MeasurementItemFieldController extends BaseController {
    ...
    public Json getList() throws Exception {
        ...
        attributes.put("measurementTemplate", measurementTemplateService.getById(measurementTemplateId));
    ...
    public Json saveOrUpdate() throws CustomException {
        if (StringUtils.isEmpty(pageMeasurementItemField.getMeasurementUnitId()))
            throw new CustomException(JsonMessage.PARAM_INVALID, "记录方式不能为空");
