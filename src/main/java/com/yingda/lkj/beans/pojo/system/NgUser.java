...
public class NgUser {
    ...
    private final static String jeecgUrlConfig = bundle.getString("jeecg_url");
    ...
    private String jeecgUrl;

    public NgUser() {
        this.name = "";
        this.avatar = "./assets/tmp/img/avatar.jpg";
        this.email = "";
        this.jeecgUrl = jeecgUrlConfig;
    }
    ...
    public String getJeecgUrl() {
        return jeecgUrl;
    }

    public void setJeecgUrl(String jeecgUrl) {
        this.jeecgUrl = jeecgUrl;
    }
}
